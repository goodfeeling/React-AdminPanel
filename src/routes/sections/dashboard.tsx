...
const MenuLevel2a = lazy(
  () => import("@/pages/menu-level/menu-level-1b/menu-level-2a")
);
const MenuLevel3a = lazy(
  () => import("@/pages/menu-level/menu-level-1b/menu-level-2b/menu-level-3a")
);
const MenuLevel3b = lazy(
  () => import("@/pages/menu-level/menu-level-1b/menu-level-2b/menu-level-3b")
);
